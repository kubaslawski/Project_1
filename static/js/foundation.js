document.addEventListener("DOMContentLoaded", function() {
    ...
    class FormSteps {
      ...
      updateForm() {
        ...
        document.getElementById('summary_name').innerHTML = name 
        document.getElementById('summary_description').innerHTML = description
        document.getElementById('summary_type').innerHTML = type
        document.getElementById('summary_category').innerHTML = catArrName.join(", ") 
